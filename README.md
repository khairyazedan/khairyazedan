...
|-------|----------|-------------|
| [OOP Principles](#) | C# | Core OOP concepts — Encapsulation, Inheritance, Polymorphism, Abstraction |
| [SOLID Principles & Design Patterns](https://github.com/khairyazedan/Design-Patterns-SOLID-Principles-C-Sharp) | C# | All 5 SOLID principles and all 23 GoF Design Patterns with practical examples |
